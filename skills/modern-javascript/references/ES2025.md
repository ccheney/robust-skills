...
Practical baseline: **Node 24 LTS and current evergreen browsers cover all of ES2025.** On Node 22, `RegExp.escape`, Float16, inline modifiers, duplicate named groups, and `Promise.try` are missing. Re-check [MDN Browser Compatibility Data](https://github.com/mdn/browser-compat-data) against the project's targets.
