...
- [ES2017](#es2017-es8)
  ...
  - [Object.values and Object.entries](#objectvalues-and-objectentries)
  - [String padding](#string-padding)
  - [Object.getOwnPropertyDescriptors](#objectgetownpropertydescriptors)
  - [Trailing commas in function parameters](#trailing-commas-in-function-parameters)
...
In browsers, constructing or sharing a `SharedArrayBuffer` generally also requires a cross-origin-isolated document. That security policy is a web-platform requirement, separate from the ECMAScript API.
