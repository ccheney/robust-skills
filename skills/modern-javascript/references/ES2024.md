...
- [Object.groupBy and Map.groupBy](#objectgroupby-and-mapgroupby)
- [Promise.withResolvers](#promisewithresolvers)
- [Well-formed Unicode strings](#well-formed-unicode-strings)
- [RegExp v flag](#regexp-v-flag-unicode-sets)
- [Resizable ArrayBuffers and transfer](#resizable-arraybuffers-and-transfer)
- [Atomics.waitAsync](#atomicswaitasync)
- [Browser and Node.js support](#browsernodejs-support)
...
All of these are in Node 22 and current evergreen browsers, but older WebViews and embedded runtimes may lag. Re-check [MDN Browser Compatibility Data](https://github.com/mdn/browser-compat-data) against the project's targets.
